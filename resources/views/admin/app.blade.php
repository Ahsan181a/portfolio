...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('admin/backend/css/main.css') }}" />
...
<body class="app sidebar-mini rtl">
    ...
    <script src="{{ asset('admin/backend/js/jquery-3.3.1.min.js') }}"></script>
    ...
    <script src="{{ asset('admin/backend/js/plugins/pace.min.js') }}"></script>
