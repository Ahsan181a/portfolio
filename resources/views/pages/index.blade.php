...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="{{asset('admin/fontend')}}/assets/img/favicon.ico" />
        ...
        <link href="{{asset('admin/fontend')}}/css/styles.css" rel="stylesheet" />
    </head>
    <body id="page-top">
        <!-- Navigation-->
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top"><img src="{{asset('admin/fontend')}}/assets/img/navbar-logo.svg" alt="" /></a>
        ...
        <header class="masthead">
            <div class="container">
                ...
                <a class="btn btn-secondary btn-xl text-uppercase js-scroll-trigger" href="{{url($main->resume)}}">Resume</a>
            </div>
        </header>
        <!-- Services-->
        ...
        <footer class="footer py-4">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-4 text-lg-left">Copyright © my Website 2021</div>
       ...
       @endforeach
        ...
        <!-- Contact form JS-->
        <script src="{{asset('admin/fontend')}}/assets/mail/jqBootstrapValidation.js"></script>
        <script src="{{asset('admin/fontend')}}/assets/mail/contact_me.js"></script>
        <!-- Core theme JS-->
        <script src="{{asset('admin/fontend')}}/js/scripts.js"></script>
    </body>
</html>
